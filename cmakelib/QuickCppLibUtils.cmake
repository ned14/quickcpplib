...
function(find_quickcpplib_library libraryname)
  ...
  if(NOT ${libraryname}_FOUND)
    ...
    elseif(NOT DEFINED FINDLIB_LOCAL)
...
" CXX_HAS_COROUTINES${iter})
    ...
    if(NOT HAVE_COROUTINES)
      ...
      if(CLANG OR GCC)
        ...
        if(CXX_HAS_COROUTINES_CLANG_GCC_LIBCXX)
          ...
          set(CXX_COROUTINES_USING_LIBCXX_ON_LINUX TRUE CACHE BOOL "Whether to force a static link for shared libraries due to use of an incompatible STL" FORCE)
          set(HAVE_COROUTINES 1)
        endif()
      endif()
    endif()
  ...
  if(CXX_COROUTINES_FLAGS AND NOT CXX_COROUTINES_FLAGS STREQUAL "unsupported")
    foreach(target ${ARGN})
      ...
      if(CXX_COROUTINES_USING_LIBCXX_ON_LINUX)
        set_target_properties(${target} PROPERTIES USING_LIBCXX_ON_LINUX On)
      endif()

...
function(write_cached_scan_file mode path var)
  ...
  foreach(dir ${dirs})
    ...
    set(contents "${contents}  \"${dirts}\" \"${dir}\"\n")
  endforeach()
  set(contents "${contents})\n")
  file(${mode} "${path}" "${contents}")
endfunction()

# Include a cached scan file and check its directory timestamps,
# if any are stale then delete the cached scan file
function(include_or_delete_cached_scan_file path var)
  if(EXISTS "${path}")
    include("${path}")
    if(${var}_DIRECTORIES)
      set(plsdelete FALSE)
...
include_or_delete_cached_scan_file("${CMAKE_CURRENT_SOURCE_DIR}/cmake/headers.cmake" "${PROJECT_NAME}_HEADERS")
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src")
  include_or_delete_cached_scan_file("${CMAKE_CURRENT_SOURCE_DIR}/cmake/sources.cmake" "${PROJECT_NAME}_SOURCES")
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/test")
  include_or_delete_cached_scan_file("${CMAKE_CURRENT_SOURCE_DIR}/cmake/tests.cmake" "${PROJECT_NAME}_TESTS")

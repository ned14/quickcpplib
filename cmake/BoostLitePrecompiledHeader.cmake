...
function(add_precompiled_header outvar headerpath)
  ...
  if(MSVC)
    ...
    message(STATUS "MSVC type precompiled header target ${headerpath} => ${pchpath}")
  else()
    ...
    if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
      ...
      message(STATUS "Clang type precompiled header target ${headerpath} => ${CMAKE_CURRENT_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/${outvar}_pch.dir/include/${headerpath}.o")
    else()
      ...
      message(STATUS "GCC type precompiled header target ${headerpath} => ${CMAKE_CURRENT_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/${outvar}_pch.dir/include/${headerpath}.o")
    endif()
  endif()
endfunction()
...
function(add_cxx_module outvar headerpath)
  # cmake 3.3 is needed for this function to work (adding dependencies to an INTERFACE target)
  if(CMAKE_VERSION VERSION_LESS 3.3)
    message(FATAL_ERROR "cmake v3.3 is required to use the add_cxx_module() function")
  endif()
  get_filename_component(header "${headerpath}" NAME)
  set(sources "include/${headerpath}")
  if(MSVC)
  ...
  if(MSVC)
    ...
    message(FATAL_ERROR "FATAL: C++ Modules not implemented for compilers other than MSVC yet")
  endif()
endfunction()

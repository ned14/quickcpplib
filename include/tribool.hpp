...
namespace std
{
  inline istream &operator>>(istream &s, boost_lite::tribool::tribool &a)
  {
    char c;
    s >> c;
    a = (c == '1') ? boost_lite::tribool::tribool::true_ : (c == '0') ? boost_lite::tribool::tribool::false_ : boost_lite::tribool::tribool::other;
    return s;
  }
  inline ostream &operator<<(ostream &s, boost_lite::tribool::tribool a)
  {
    char c = (a == boost_lite::tribool::tribool::true_) ? '1' : (a == boost_lite::tribool::tribool::false_) ? '0' : '?';
    return s << c;
  }
}

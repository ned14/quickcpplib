...
/********** Here comes the Boost-lite specific stuff ************/
...
#define BOOSTLITE_ANNOTATE_RWLOCK_ACQUIRED(NOTATE_RWLOCK_ACQUIRED(p, s)
...
#define BOOSTLITE_ANNOTATE_IGNORE_READS_END() ANNOTATE_IGNORE_REDS_END()

...
#define BOOST_LOCAL_BIND_NAMESPACE_SELECT_(...) BOOST_LOCAL_BIND_CALL_OVERLOAD(BOOST_LOCAL_BIND_NAMESPACE_SELECT_,__VA_ARGS__)
#define BOOST_LOCAL_BIND_NAMESPACE_SELECT(...) BOOST_LOCAL_BIND_CALL_OVERLOAD(BOOST_LOCAL_BIND_NAMESPACE_SELECT,__VA_ARGS__)
#define BOOST_LOCAL_BIND_NAMESPACE_EXPAND8(a, b, c, d, e, f, g, h) BOOST_LOCAL_BIND_NAMESPACE_SELECT a BOOST_LOCAL_BIND_NAMESPACE_EXPAND7(b, c, d, e, f, g, h)
#define BOOST_LOCAL_BIND_NAMESPACE_EXPAND7(a, b, c, d, e, f, g) BOOST_LOCAL_BIND_NAMESPACE_SELECT a BOOST_LOCAL_BIND_NAMESPACE_EXPAND6(b, c, d, e, f, g)
#define BOOST_LOCAL_BIND_NAMESPACE_EXPAND6(a, b, c, d, e, f) BOOST_LOCAL_BIND_NAMESPACE_SELECT a BOOST_LOCAL_BIND_NAMESPACE_EXPAND5(b, c, d, e, f)
#define BOOST_LOCAL_BIND_NAMESPACE_EXPAND5(a, b, c, d, e) BOOST_LOCAL_BIND_NAMESPACE_SELECT a BOOST_LOCAL_BIND_NAMESPACE_EXPAND4(b, c, d, e)
#define BOOST_LOCAL_BIND_NAMESPACE_EXPAND4(a, b, c, d) BOOST_LOCAL_BIND_NAMESPACE_SELECT a BOOST_LOCAL_BIND_NAMESPACE_EXPAND3(b, c, d)
#define BOOST_LOCAL_BIND_NAMESPACE_EXPAND3(a, b, c) BOOST_LOCAL_BIND_NAMESPACE_SELECT a BOOST_LOCAL_BIND_NAMESPACE_EXPAND2(b, c)
#define BOOST_LOCAL_BIND_NAMESPACE_EXPAND2(a, b) BOOST_LOCAL_BIND_NAMESPACE_SELECT a BOOST_LOCAL_BIND_NAMESPACE_EXPAND1(b)
...
#define BOOST_LOCAL_BIND_NAMESPACE_BEGIN_NAMESPACE_SELECT(...) BOOST_LOCAL_BIND_CALL_OVERLOAD(BOOST_LOCAL_BIND_NAMESPACE_BEGIN_NAMESPACE_SELECT,__VA_ARGS__)
...
#define BOOST_LOCAL_BIND_NAMESPACE_END_NAMESPACE_SELECT(...) BOOST_LOCAL_BIND_CALL_OVERLOAD(BOOST_LOCAL_BIND_NAMESPACE_END_NAMESPACE_SELECT,__VA_ARGS__)
